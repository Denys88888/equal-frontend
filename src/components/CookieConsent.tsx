  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="w-full max-w-[400px] rounded-2xl p-4 shadow-lg" style={{ backgroundColor: 'var(--card-bg)', boxShadow: '0 -4px 24px rgba(0,0,0,0.1)' }}>
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-[var(--charcoal)] mb-1" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>
                  {t('common.cookieTitle')}
                </p>
                <p className="text-xs leading-relaxed mb-3" style={{ color: 'rgba(var(--charcoal-rgb), 0.65)', fontFamily: "'Outfit', system-ui, sans-serif", lineHeight: 1.5 }}>
                  {t('common.cookieText')}{' '}
                ...
                <div className="flex gap-2">
                  ...
                  <motion.button whileTap={{ scale: 0.95 }}
                    ...
                    style={{ backgroundColor: 'rgba(var(--linen-rgb), 0.5)', color: 'var(--charcoal)', fontFamily: "'Outfit', system-ui, sans-serif" }}>
                    {t('common.cookieEssential')}
                  </motion.button>
                </div>
              </div>
              <motion.button whileTap={{ scale: 0.85 }} onClick={decline} className="flex-shrink-0">
                <X size={18} style={{ color: 'rgba(var(--charcoal-rgb), 0.4)' }} />
              </motion.button>
            </div>
          </div>
        </motion.div>
